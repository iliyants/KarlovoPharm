namespace KarlovoPharm.Web.InputModels.Products.Edit
{
    using AutoMapper;
    ...
    public class ProductEditInputModel : IMapFrom<Product>,IMapTo<Product>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<Product, ProductEditInputModel>()
